...
public class DashboardComToastTipos extends JFrame {

    private final JTable tabela;
    private DefaultTableModel modeloTabela;

    public DashboardComToastTipos() {
        setTitle("Dashboard com Toasts Diferenciados");
        ...
        // Ações com toast messages diferenciados
    ...
    // Método para exibir toast com cores diferentes
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> {
            new DashboardComToastTipos().setVisible(true);
        });
    }
}
